export const subCategories = {
  ...
  "Snacks": [
    "Aceitunas/Champignon",
    "Bocaditos/Pororo",
    "Mani",
    "Nachos/Palitos Salados",
    "Varios snacks",
    "Papas Fritas",
    "Pepinos/Pickles"
  ],
  ...
  "Accesorios": [
    "Cepillos",
    "Escobas/Escurridores/Palitas",
    "Esponjas/Lanas",
    "Guantes",
    "Plumeros",
    "Rejillas/Trapos de Piso"
  ],
  "Alimentos": [
    "Cereales",
    "Preparados"
  ...
  "Escolar": [
    "Agendas/Blocks/Diarios",
    "Cuadernos",
    "Libros/Diccionarios",
    "Merenderos/Termos/Papelera",
    "Papelería/Sobres",
    "Pastas para Moldear"
  ],
  "Otros-Artículos": [
